  ...
  return (
    ...
    <div className="max-h-[800px] grid grid-cols-2 gap-2">
        {orderData?.[0]?.results.map((item, idx)=> {
            return <div className={`p-4 border border-b-2 flex flex-col cursor-pointer gap-2 hover:bg-gray-50`} key={idx}  onClick={() => {
                ...
                <div className="flex items-center justify-between">  
                    ...
                    <p className="text-sm font-light">{humanDatetime(item?.orderDate)}</p>
                </div>
