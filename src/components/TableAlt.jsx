...
const TableAlt = (props) => {
  const {isLoading,list, handleNext, handlePrevious,children, title } = props
  const [currentPage, setCurrentPage] = useState(1);


  const itemsPerPage = 5;
  const totalPages = Math.ceil(list?.totalCount / itemsPerPage);
                    ...
                    <div className="px-2 py-3 flex justify-between items-center border rounded-lg">
                      ...
                      {(list?.hasPreviousPage || list?.hasNextPage) &&   
                        ...
                        <button
                          ...
                          disabled={!list?.hasPreviousPage || isLoading}
                        ...
                        <button
                          ...
                          disabled={!list?.hasNextPage || isLoading}
