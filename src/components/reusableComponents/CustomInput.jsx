...
const CustomInput = ({type, placeholder, name, register, label, errors, required, onFocus, onBlur}) => {
  ...
  return (
    ...
    <div className="relative">
        ...
        {
            type == 'password' && (
            <div className="cursor-pointer absolute right-4 bottom-5" onClick={handleTogglePass}>
