            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {isLoading ? (
                ...
                orderItems?.map((item, idx) => {
                  const itemPrice =
                    item?.quantity *
                    (item?.menu ? item.menu.price : item.extra.price);
                  return (
                    <tr key={idx}>
        ...
        {isLoading || orderItemsLoading ? (
          ...
          <div className="p-4 flex flex-col w-full gap-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <p
                    className="font-bold"
                    onClick={() => window.open("tel:" + data?.user.contact)}
                  >
                    {data?.user.contact}
                  </p>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <p className="text-3xl font-extrabold text-sm text-gray-500">
                    {humanDatetime(data?.orderDate)}
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div />
              <div className="font-bold text-xl flex justify-end">
